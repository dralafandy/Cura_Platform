...
import { InventoryItem, NotificationType, Supplier, PurchaseOrder } from '../../types';
...
}> = ({ item, supplier, status, onEdit, onDelete, onQuickStockUpdate, getStockPercentage, getStockColor }) => {
